...
usage: Tem um arquivo py_blacklist_files.txt o qual funciona como um gitignore so para esse script. Escreva utilizando a mesma formatação do git ignore e evitra ler arquivos indesejados.
